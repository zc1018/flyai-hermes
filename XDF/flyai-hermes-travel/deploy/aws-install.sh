...
XHS_ENABLED=${XHS_ENABLED:-false}
MEDIACRAWLER_DIR=${MEDIACRAWLER_DIR:-/home/ec2-user/MediaCrawler}
XHS_LOGIN_TYPE=${XHS_LOGIN_TYPE:-cookie}
XHS_COOKIES=${XHS_COOKIES:-}
XHS_CACHE_TTL_HOURS=${XHS_CACHE_TTL_HOURS:-12}
XHS_TIMEOUT_SECONDS=${XHS_TIMEOUT_SECONDS:-45}
XHS_MAX_RESULTS=${XHS_MAX_RESULTS:-6}
XHS_MAX_DAILY_PER_USER=${XHS_MAX_DAILY_PER_USER:-10}
EOF
